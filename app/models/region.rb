class Region < ActiveRecord::Base
  ...
  belongs_to :country
    ...
    CATEGORIES_NOT_ALLOWED =
        [10, 20, 40, 60, 80, 100, 110, 140, 150, 160, 190, 210, 220, 230, 240, 250, 260, 280];

    CATEGORIES_LANDLINE = [30, 50, 70, 120, 170, 200, 270]

    CATEGORIES_MOBILE = [90, 180]

    CATEGORIES_SATELLITE = [130]
end
