...
class ContactEmailsControllerTest < ActionController::TestCase
  ...
  test "should create contact_email" do
    assert_difference('ContactEmail.count') do
      post :create, contact_email: { email: @contact_email.email, message: @contact_email.message, name: @contact_email.name, pin: @contact_email.pin, purpose: @contact_email.purpose }
    end
  ...
  test "should update contact_email" do
    put :update, id: @contact_email, contact_email: { email: @contact_email.email, message: @contact_email.message, name: @contact_email.name, pin: @contact_email.pin, purpose: @contact_email.purpose }
    assert_redirected_to contact_email_path(assigns(:contact_email))
  end
